...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/16 16:39:37 by fabet             #+#    #+#             */
/*   Updated: 2022/10/16 16:39:39 by fabet            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "executor.h"

static int	ft_create_heredoc(t_lexer *heredoc, bool quotes,
	t_tools *tools, char *file_name)
{
	...
	{
		if (quotes == false)
			line = ft_start_expander_str(tools, line);
...
int	ft_heredoc(t_tools *tools, t_lexer *heredoc, char *file_name)
{
	...
	sl = ft_create_heredoc(heredoc, quotes, tools, file_name);
